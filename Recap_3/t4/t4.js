...
// your code here
/*
otetaan oma sijainti (DOM POM dokumentaatiossa) (palauttaa POS olion, jossa pos.coords.latitude ja pos.coords.longitude??)
iteroidaan ravintolat ja lasketaan niiden etäisyys omasta sijainnista
lisätään etäisyys ravintolaan (sinne objektiin ominaisuudeksi)
sortataan ravintolat etäisyyden mukaan
tulostetaan ravintolat HTML:ään hienosti

DOM POM dokumentaatiosta löytyy sijainnin hakemiseen tarvittavat metodit (success ja errorit yms kaikki)
SUCCESSIIN meni etäisyyden laskeminen sisälle.
*/
...
// Gets real global distance between two coordinates
function globaldistance(lat1, lon1, lat2, lon2) {
...
function success(pos) {
  // Pass pos to distance calculator:
  getpos(pos);

  // We now have pos so we can calculate distances
  restaurants.sort((a, b) => a.distance - b.distance);

  // Print to HTML in order
  ...
  restaurants.forEach((resta) => {
    ...
    thname.textContent = resta.name;
    thaddress.textContent = resta.address;
    thdistance.textContent = resta.distance;
...
// Get user location
// This takes time, so we need to wait for it to finish
